...
urlpatterns = [
    ...
    path("password_reset/", auth_views.PasswordResetView.as_view(template_name='Hireo/password_reset_form.html', html_email_template_name="Hireo/password_reset_html_email.html", subject_template_name="Hireo/password_reset_subject.txt"), name="password_reset"),
